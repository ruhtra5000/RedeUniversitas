...
# Função para marcar métricas específicas na página, como st.metric, para aplicar estilos personalizados.
def marcarMetricasPagina():
    st.html('<span class="pv-metrics-marker"></span>')

# Função para marcar tabelas específicas na página, como DataFrames ou DataEditors, para aplicar estilos personalizados.
def marcarTabelaPagina():
    st.html('<span class="pv-table-marker"></span>')

# Função para marcar ações específicas na página, como botões ou links, para aplicar estilos personalizados.
def marcarAcoesPagina():
    st.html('<span class="pv-actions-marker"></span>')

# Função para marcar painéis específicos na página, como contêineres com bordas, para aplicar estilos personalizados.
...
# Função para renderizar o topo da página com título, descrição e categoria, aplicando estilos personalizados.
...
# Context manager para criar um painel na página com título, descrição e categoria, aplicando estilos personalizados.
@contextmanager
def painelPagina(
    titulo: str,
    descricao: str,
...
# Função para renderizar uma seção na página com número, título e descrição, aplicando estilos personalizados.
...
# Função para renderizar um divisor na página, aplicando estilos personalizados.
def renderizarDivisorPagina():
    st.html('<div class="pv-divider"></div>')

# Função para renderizar um status na página com rótulo e valor, aplicando estilos personalizados.
...
# Função para aplicar os estilos específicos da página de gestão financeira.
def aplicarEstiloGestaoFinanceira():
    st.html("""
        <style>
        ...
        .gf-campus-dot {
            ...
            border-radius: 999px;
            background: #C49A4A;
            box-shadow: 0 0 0 3px rgba(196, 154, 74, 0.10);
        }
...
# Função para aplicar o estilo CSS personalizado na página de gestão financeira
