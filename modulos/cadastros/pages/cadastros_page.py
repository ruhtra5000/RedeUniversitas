    ...
    with placeholder_principal.container():
        ...
        with st.container(horizontal=True):
            ...
            with st.container(height=altura_cartao, border=True):
                ...
                matricula_btn = st.button("Acessar", key="btn_matricula", use_container_width=True)
        ...
        with st.container(horizontal=True):
            with st.container(height=altura_cartao, border=True):
                ...
                campus_btn = st.button("Acessar", key="btn_campus", use_container_width=True)
            ...
            with st.container(height=altura_cartao, border=True):
                ...
                almoxarife_btn = st.button("Acessar", key="btn_almoxarife", use_container_width=True)
            ...
            with st.container(height=altura_cartao, border=True):
                ...
                bolsa_btn = st.button("Acessar", key="btn_bolsa", use_container_width=True)
        ...
        with st.container(horizontal=True):
            with st.container(height=altura_cartao, border=True):
                ...
                financeiro_btn = st.button("Acessar", key="btn_financeiro", use_container_width=True)
            ...
            with st.container(height=altura_cartao, border=True):
                ...
                fornecedor_btn = st.button("Acessar", key="btn_fornecedor", use_container_width=True)
            ...
            with st.container(height=altura_cartao, border=True):
                ...
                compra_btn = st.button("Acessar", key="btn_compra", use_container_width=True)
        ...
        with st.container(horizontal=True):
            with st.container(height=altura_cartao, border=True):
                ...
                estoque_btn = st.button("Acessar", key="btn_estoque", use_container_width=True)
