...
# Gestão unificada
aluno_page = st.Page(tela_aluno_unificada, title="Alunos", icon=":material/school:", url_path="alunos")
professor_page = st.Page(tela_professor_unificada, title="Professores", icon=":material/person:", url_path="professores")
curso_page = st.Page(tela_curso_unificada, title="Cursos", icon=":material/local_library:", url_path="cursos")
disciplina_page = st.Page(tela_disciplina_unificada, title="Disciplinas", icon=":material/menu_book:", url_path="disciplinas")
turma_page = st.Page(tela_turma_unificada, title="Turmas", icon=":material/account_balance:", url_path="turmas")
almoxarife_page = st.Page(tela_almoxarife_unificada, title="Almoxarifes", icon=":material/inventory_2:", url_path="almoxarifes")
bolsa_page = st.Page(tela_bolsa_unificada, title="Bolsas", icon=":material/redeem:", url_path="bolsas")
campus_page = st.Page(tela_campus_unificada, title="Campus", icon=":material/account_balance:", url_path="campus")
compra_page = st.Page(tela_compra_unificada, title="Compras", icon=":material/shopping_cart:", url_path="compras")
financeiro_page = st.Page(tela_financeiro_unificada, title="Financeiro", icon=":material/payments:", url_path="financeiro")
fornecedor_page = st.Page(tela_fornecedor_unificada, title="Fornecedores", icon=":material/factory:", url_path="fornecedores")
matricula_page = st.Page(tela_matricula_unificada, title="Matrículas", icon=":material/edit_document:", url_path="matriculas")
estoque_page = st.Page(tela_estoque_unificada, title="Estoque", icon=":material/inventory_2:", url_path="estoque")
